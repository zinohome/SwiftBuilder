...
class Schemagroup(SwiftSQLModel, table=True):
    ...
    application_id: Optional[int] = models.Field(default=None,
                                                    ...
                                                    amis_form_item = "",
                                                    amis_table_column = "")
    group_name: str = models.Field(default="ApplicaionGroup",
                                                    title='导航组名称',
                                                    nullable=False,
                                                    index=False,
                                                    amis_form_item = "",
                                                    amis_table_column = "")
    group_schema: str = models.Field(default="Application",
                                                    title='导航组模式',
                                                    nullable=False,
                                                    index=False,
                                                    amis_form_item = "",
                                                    amis_table_column = "")
    label: str = models.Field(default="应用管理",
                                                    title='导航组标签',
                                                    nullable=False,
                                                    index=False,
                                                    amis_form_item = "",
                                                    amis_table_column = "")
    title: str = models.Field(default="应用管理",
                                                    title='导航组标题',
                                                    nullable=False,
                                                    index=False,
                                                    amis_form_item = "",
                                                    amis_table_column = "")
    icon: str = models.Field(default="fa fa-bolt",
                                                    title='导航组图标',
                                                    nullable=False,
                                                    index=False,
                                                    amis_form_item = "",
                                                    amis_table_column = "")
    sort: str = models.Field(default="98",
                                                    title='导航组顺序',
                                                    nullable=False,
                                                    index=False,
                                                    amis_form_item = "",
                                                    amis_table_column = "")
    router_prefix: str = models.Field(default="/application",
                                                    title='导航组路径',
                                                    nullable=False,
                                                    index=False,
                                                    amis_form_item = "",
